...
object WeatherTestData {
    ...
    fun makeXuApiResponse(): XuWeatherForecast {
        return  Gson().fromJson(mock4DayResponse, XuWeatherForecast::class.java)

    }


    fun makeWeatherForecast(): WeatherForecast {
        return WeatherForecast(23.0, "London", arrayListOf<Forecastday>().apply {
            intArrayOf(1, 2, 3, 4).forEach { it -> add(Forecastday("23-3-2019", 838848434, Day(30.0))) }})
    }
